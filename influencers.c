...
void obtener_horas_sueno(int *horas_sueno);
...
//Main
/*Analisis:
	su función es representar la batalla del Abismo de Helm, trabaja mediante funciones que invoca, para finalmente mostrar el resumen de la batalla.
Pre-condiciones: -.
Post-condiciones:
	el programa muestra por pantalla un mensaje del resumen de la batalla.*/
int main(){   
...
void mostrar_mensaje_error_general(int numero){
	...
	switch (numero){
        ...
        case 3:
        	...
        	break;       
        case 4:
        	printf("Nonono, usted tiene que arrepentirse de lo que dijo. Ingresó anterior ");
        	break;
        case 5:
...
void obtener_horas_sueno(int *horas){
    ...
    do {
        ...
        if (cont > 0) mostrar_error_numero(*horas);
...
void mostrar_mensaje_inicial(int i){
	...
	if (i == 0) printf(MAGENTA "Increible. Ahora le haré preguntas sobre " AZUL PRIMER_PERSONAJE MAGENTA".\n");
    else printf(MAGENTA ", ahora le haré preguntas sobre " AZUL SEGUNDO_PERSONAJE MAGENTA ".\n");
}
...
void mostrar_datos_ingresados(int dia, char momento, char pie_primer_personaje, char cena_primer_personaje, int horas_sueno_primer_personaje, char pie_segundo_personaje, char cena_segundo_personaje, int horas_sueno_segundo_personaje){
    ...
    printf(PUNTO_NEGRO AMARILLO "Día del mes: " BLANCO "%i. \n" FIN, dia);
    printf(PUNTO_NEGRO AMARILLO "Hora del día: " BLANCO "%c. \n" FIN, momento);
    printf(PUNTO_NEGRO AMARILLO "Ánimo de " AZUL PRIMER_PERSONAJE FIN ": \n");
    printf(SANGRIA CUADRADO_BLANCO AMARILLO "Pie con el que se levantó: " BLANCO "%c. \n" FIN, pie_primer_personaje);
    printf(SANGRIA CUADRADO_BLANCO AMARILLO "Cena de la noche anterior: " BLANCO "%c. \n" FIN, cena_primer_personaje);
    printf(SANGRIA CUADRADO_BLANCO AMARILLO "Cantidad de horas que durmió: " BLANCO "%i. \n" FIN, horas_sueno_primer_personaje);
    printf(PUNTO_NEGRO AMARILLO "Ánimo de " AZUL SEGUNDO_PERSONAJE FIN ": \n");
